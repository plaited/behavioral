...
import { handleFrontierMessage } from '../behavior.ts'
...
// ---------------------------------------------------------------------------
// Liveness and state-graph behavior — ported from the former fleet-tool
// liveness spec. No fake-graph builders, no direct imports of the graph
// internals: SCC/livelock/stateKey behavior is asserted through the worker
