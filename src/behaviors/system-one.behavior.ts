...
import { configSystemOne, type SystemOneRespond } from './config-system-one.ts'
import { validateSystemOneOutput } from './system-one.schemas.ts'
import type { SystemOneOutput } from './system-one.types.ts'
